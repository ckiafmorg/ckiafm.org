...
ActiveRecord::Schema[7.0].define(version: 2023_03_17_155448) do
  ...
  create_table "categorie_adhesions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.integer "montant"
    t.string "nom"
    t.datetime "created_at", null: false
  ...
  create_table "emisisons_user", id: false, force: :cascade do |t|
    ...
    t.bigint "emisison_id", null: false
  end
  ...
  create_table "taggables", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "emission_id", null: false
    t.uuid "tags_emission_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["emission_id"], name: "index_taggables_on_emission_id"
    t.index ["tags_emission_id"], name: "index_taggables_on_tags_emission_id"
  end

  create_table "tags_emissions", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.string "nom"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
  ...
  add_foreign_key "taggables", "tags_emissions"
end
